...
kdensity _sim_3, xtitle(Estimated ATT) xline(603, lwidth(medthick) lpattern(dash) lcolor(blue) extend) xlabel(677 603)  xline(677, lwidth(med) lpattern(solid) lcolor(red) extend) subtitle(Saturated regression) ytitle("") title("") note("")
