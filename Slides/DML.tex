...
The curse of dimensionality is a concern in any high-dimensional estimation problem, but you don't hear it discussed often with the DML method and there are a few reasons it may not be

\begin{enumerate}
\item[1. ] Machine Learning Techniques: DML often incorporates machine learning methods that are robust to high-dimensional data. Methods like Lasso, Random Forests, or Gradient Boosting are designed to handle large numbers of features, potentially mitigating the curse of dimensionality to some extent.
...
\item[2. ] Double-Residualization: The double-residualization step in DML could help reduce dimensionality by focusing on the component of the target variable and treatment variable that cannot be explained by the high-dimensional controls.
...
\item[3. ] Sparsity: In many empirical applications, the true underlying model may be sparse, even if it's high-dimensional. Many machine learning techniques incorporated within DML are good at picking up this sparsity.
