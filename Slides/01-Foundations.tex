...
\begin{enumerate}
\item [7.] Advanced and Frontiers in DiD (Jon Roth, Brown; Brantly Callaway, UGA)
\item [8.] Machine Learning and Heterogeneous Treatment Effects (Brigham Frandsen, BYU)
\item [9.] Design (Peter Hull, Brown)
\item [10.] Shift-Share (Peter Hull, Brown)
\item [11.] Empirical Bayes (Chris Walters, Berkeley)
\item [12.] BLP (Ariel Pakes, Harvard)
...
\item Causal inference has many mothers and fathers: Aristotle, Hume, Mill, Lewis
...
\begin{frame}{Why Control Variables?}
  \begin{itemize}
    \item There are 2 main reasons for including additional controls in the regression models:
          ...
          \end{enumerate}
    \item Ongoing work by econometricians is investigating this more carefully, some of which we cover tomorrow
  \end{itemize}
\end{frame}
...
\begin{frame}{Thoughts you want to keep in mind}
  ...
  \begin{itemize}
  \item Even when we don't run our own experiments, the experimental design is helpful for starting your project    \item Describe the way you would conduct the RCT by explaining the following:
          \begin{itemize}
          \item What is the research question? 
         \item What aggregate causal parameter?
          \item What experiment am I running? 
