...
Let's now review the syntax in Stata.  It's called \texttt{comparing.do} and is in /Labs/Matching 
...
\item Let's look at a picture again just to remind ourselves (and we can look at \texttt{comparing.do} again)
...
Lets look at the \texttt{comparing.do} again
